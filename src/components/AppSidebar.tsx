...
import { Home, Package, User, Building2, BarChart3, CreditCard, Settings, HelpCircle, Bell, FileText, Shield, TrendingUp, Users, Database, Link, Route, Heart, RefreshCw } from "lucide-react"
...
const publicItems = [
  ...
  { title: "Secondary Market", url: "/secondary-market", icon: RefreshCw },
]
